...
public class LibrarianHome extends javax.swing.JFrame {
    ...
    public LibrarianHome(Staff librarian) {
        initComponents();
        this.librarian = librarian;
        welcome.setText("Welcome "+librarian.getFname());
    }
    ...
    private void initComponents() {
        ...
        manageBooksBtn.setBackground(new java.awt.Color(0, 204, 255));
        manageBooksBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jButton1.setText("Book Borrowings");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(24, 24, 24)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(welcome, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(manageBooksBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void logoutBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutBtnActionPerformed
        ...
        if(librarian.getType().equals(CommonConstants.USER_TYPE_ADMIN)){
            new AdminHome(librarian).setVisible(true);
        } else {
    ...
    private void manageBooksBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageBooksBtnActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        new ManageBooks(this.librarian).setVisible(true);
